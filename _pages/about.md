...
Currently, I am working on the dynamics and mitigations of reward hacking in rubric-based reinforcement learning (introducing [CHERRL (Controllable Hacking Environment for Rubric-based RL)](https://github.com/THUAIS-Lab/CHERRL)). 
